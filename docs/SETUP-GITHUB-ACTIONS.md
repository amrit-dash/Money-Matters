...
CI generates `ios/ExportOptions.ci.plist` from the profile during the build (manual export signing (archive automatic or unsigned; export uses imported profile + Apple Development cert)).
